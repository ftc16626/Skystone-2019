...
public class DetectMotorSpeedTeleop extends OpMode {
  ...
  private void collectAndPushSamples() {
    ...
    missionControl.logAndBroadcast(
        new LogModel(time + "," + deltaEncoderFrontLeft, "EncoderDeltaFrontLeft", new Date()));
    missionControl.logAndBroadcast(
        new LogModel(time + "," + deltaEncoderFrontRight, "EncoderDeltaFrontRight", new Date()));
    missionControl.logAndBroadcast(
        new LogModel(time + "," + deltaEncoderBackLeft, "EncoderDeltaBackLeft", new Date()));
    missionControl.logAndBroadcast(
        new LogModel(time + "," + deltaEncoderBackRight, "EncoderDeltaBackRight", new Date()));
