...
public class SkyStoneDeliverFoundationMiddle implements DeliveryPath {
  private DriveBaseMecanum driveBaseMecanum;
  private MainHardware mainHardware;

  private Trajectory trajectory1;

  public SkyStoneDeliverFoundationMiddle(MainHardware mainHardware, DriveBaseMecanum driveBaseMecanum) {
