...
public class SkyStoneDeliverFoundationLast implements DeliveryPath {
  private DriveBaseMecanum driveBaseMecanum;
  private MainHardware mainHardware;

  private Trajectory trajectory1;

  public SkyStoneDeliverFoundationLast(MainHardware mainHardware, DriveBaseMecanum driveBaseMecanum) {
